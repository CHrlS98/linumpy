...
#-*- coding:utf-8 -*-
"""
Apply N4 bias field correction to a volume along the slicing axis.
The bias field is estimated on a downsampled version of the image
and then applied to the full resolution image.
"""
import argparse
