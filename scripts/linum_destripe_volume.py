...
# -*- coding: utf-8 -*-
"""
Remove stripes from a 3D image using the General Stripe Remover from [1].
"""
import numpy as np
import torch
...
EPILOG=r"""
[1] Niklas Rottmayer, Claudia Redenbach, and Florian O. Fahrbach, "A universal
    and effective variational method for destriping: application to light-sheet
    microscopy, FIB-SEM, and remote sensing images," Opt. Express 33, 5800-5809
    (2025)
"""
...
def _build_arg_parser():
    ...
    p.add_argument('--mu', nargs=2, type=float, metavar=('mu_1', 'mu_2'),
                   default=[0.17, 0.003],
                   help='Optimizer parameters. [%(default)s]\n'
